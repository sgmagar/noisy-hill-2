"""
Django settings for noisy_hill_2 project.
...
ROOT_URLCONF = 'noisy_hill_2.urls'
...
WSGI_APPLICATION = 'noisy_hill_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_hill_2 API",
    "DESCRIPTION": "API documentation for noisy_hill_2 App",
    "VERSION": "v1",
}
